...
void PoolGroup<Creature>::Despawn1Object(ObjectGuid::LowType guid, bool alwaysDeleteRespawnTime, bool saveRespawnTime)
{
    if (CreatureData const* data = sObjectMgr->GetCreatureData(guid))
    {
        ...
        if (!map)
        {
            TC_LOG_ERROR("pool", "PoolGroup<Creature>::Despawn1Object: Can't despawn creature, map not found {}.", data->mapId);
            return;
        }
        if (!map->Instanceable())
        {
...
void PoolGroup<GameObject>::Despawn1Object(ObjectGuid::LowType guid, bool alwaysDeleteRespawnTime, bool saveRespawnTime)
{
    if (GameObjectData const* data = sObjectMgr->GetGameObjectData(guid))
    {
        ...
        if (!map)
        {
            TC_LOG_ERROR("pool", "PoolGroup<GameObject>::Despawn1Object: Can't despawn gameobject, map not found {}.", data->mapId);
            return;
        }
        if (!map->Instanceable())
        {
...
void PoolGroup<Creature>::Spawn1Object(PoolObject* obj)
{
    if (CreatureData const* data = sObjectMgr->GetCreatureData(obj->guid))
    {
        ...
        if (!map)
        {
            TC_LOG_ERROR("pool", "PoolGroup<Creature>::Spawn1Object: Can't spawn creature, map not found {}.", data->mapId);
            return;
        }
...
void PoolGroup<GameObject>::Spawn1Object(PoolObject* obj)
{
    if (GameObjectData const* data = sObjectMgr->GetGameObjectData(obj->guid))
    {
        ...
        if (!map)
        { 
            TC_LOG_ERROR("pool", "PoolGroup<GameObject>::Spawn1Object: Can't spawn gameobject, map not found {}.", data->mapId);
            return;
        }
...
void PoolGroup<Creature>::RemoveRespawnTimeFromDB(ObjectGuid::LowType guid)
{
    if (CreatureData const* data = sObjectMgr->GetCreatureData(guid))
    {
        ...
        if (!map)
        {
            TC_LOG_ERROR("pool", "PoolGroup<Creature>::RemoveRespawnTimeFromDB: Can't remove respawn time, map not found {}.", data->mapId);
            return;
        }
        if (!map->Instanceable())
        {
...
void PoolGroup<GameObject>::RemoveRespawnTimeFromDB(ObjectGuid::LowType guid)
{
    if (GameObjectData const* data = sObjectMgr->GetGameObjectData(guid))
    {
        ...
        if (!map)
        {
            TC_LOG_ERROR("pool", "PoolGroup<GameObject>::RemoveRespawnTimeFromDB: Can't remove respawn time, map not found {}.", data->mapId);
            return;
        }
        if (!map->Instanceable())
        {
