...
{
    TC_LOG_DEBUG("charge", "Spell::EffectCharge called {} - {}", m_spellInfo->Id, GameTime::GetGameTimeMS());
    if (!unitTarget)
        return;
    ...
    if (effectHandleMode == SPELL_EFFECT_HANDLE_LAUNCH_TARGET)
    {
        TC_LOG_DEBUG("charge", "Spell::EffectCharge SPELL_EFFECT_HANDLE_LAUNCH_TARGET {} - {}", m_spellInfo->Id, GameTime::GetGameTimeMS());
    ...
    if (effectHandleMode == SPELL_EFFECT_HANDLE_HIT_TARGET)
    {
        TC_LOG_DEBUG("charge", "Spell::EffectCharge SPELL_EFFECT_HANDLE_HIT_TARGET {} - {}", m_spellInfo->Id, GameTime::GetGameTimeMS());
