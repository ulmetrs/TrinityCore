...
enum MapQuadTreeMask : uint32_t
{
    ...
    MAPQT_CREATURE = MAPQT_GRID_CREATURE | MAPQT_WORLD_CREATURE,
    MAPQT_DYNAMICOBJ = MAPQT_GRID_DYNAMICOBJ | MAPQT_WORLD_DYNAMICOBJ,
    MAPQT_CORPSE = MAPQT_GRID_CORPSE | MAPQT_WORLD_CORPSE,
    MAPQT_GRID = MAPQT_GAMEOBJECT | MAPQT_GRID_CREATURE | MAPQT_GRID_DYNAMICOBJ | MAPQT_GRID_CORPSE,
    MAPQT_WORLD = MAPQT_PLAYER | MAPQT_WORLD_CREATURE | MAPQT_WORLD_DYNAMICOBJ | MAPQT_WORLD_CORPSE,
    MAPQT_ALL = MAPQT_GRID | MAPQT_WORLD
};
