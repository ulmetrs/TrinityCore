...
class spell_warl_seed_of_corruption_dummy : public AuraScript
{
    ...
    void CalculateBuffer(AuraEffect const* aurEff, int32& amount, bool& /*canBeRecalculated*/)
    {
        ...
        amount = caster->SpellDamageBonusDone(GetUnitOwner(), GetSpellInfo(), GetSpellInfo()->GetSchoolMask(), amount, SPELL_DIRECT_DAMAGE, aurEff->GetSpellEffectInfo(), GetAura()->GetDonePct());
    }
